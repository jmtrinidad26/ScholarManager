...
export default function StudentManagement() {
    ...
    const filteredStudents = Array.isArray(students)
        ? students.filter((student) => {
            ...
            const matchesCampus = filterCampus ? student.campus === filterCampus : true;
                        ...
                        <div className="bg-white shadow rounded-lg overflow-hidden">
                            <div className="p-6">
                                ...
                                <button
                                    onClick={() =>
                                        router.replace(
                                            "https://scholar-manager-git-main-jmtrinidads-projects-c5d38af8.vercel.app/api/students"
                                        )
                                    }
                                >
                                    Go to API
                                                ...
                                                {filteredStudents.map((student) => {
                                                    ...
                                                    return (
                                                        <tr key={student.student_id} className="hover:bg-gray-50">
                                                            ...
                                                            <td className="px-6 py-4 whitespace-nowrap">
                                                                <span
                                                                    className={`px - 2 inline  text - xs leading - 5 font - semibold rounded - full ${student.scholarship_status === "Scholar"
